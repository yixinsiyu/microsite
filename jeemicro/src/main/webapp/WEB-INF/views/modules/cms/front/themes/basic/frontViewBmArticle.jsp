...
<script type="text/javascript">
	...
	function openBaoming(){
		window.location.href="${ctx}/baoming${urlSuffix}?articleTitle="+BASE64.encoder("${article.title}");
	}
</script>
</head>
			...
			<div class="jeemicro_content_block">
				...
				<ul class="like_share_block">
					<li><a class="link_share_button" href="###"><i
							class="iconfont share_ico_wx">&#xe83e;</i>点击数：${article.hits}</a></li>
					<li><a class="link_share_button"  href="javascript:void(0)"  onclick="openBaoming();"><i
							class="iconfont share_ico_wx">&#xe612;</i>在线报名</a></li>
					<%-- <a href="${ctx}/baoming${urlSuffix}" class="iconfont jeemicro_nav_baoming"></a><span></span> --%>
				</ul>
