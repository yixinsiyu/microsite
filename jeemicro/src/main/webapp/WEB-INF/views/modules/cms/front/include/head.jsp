...
<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"/><script src="${ctxStatic}/jquery/jquery-1.9.1.min.js" type="text/javascript"></script>
...
<c:if test="${site.theme eq 'basic'}">
	...
	<link href="${ctxStatic}/common/weixin.min.css" type="text/css" rel="stylesheet" />
