...
<div id="section_container">
    <section id="login_section" class="active">
        <header>
            ...
            <nav class="right">
                <a href="../f/baoming/baomingTip"  data-icon="info">帮助</a>
            </nav>
        </header>
	            ...
	            <form id="loginForm" action="${ctx}/login" method="post">
	            	...
	            	<div class="input-group">
		                <div class="input-row">
		                    ...
		                    <input type="text" name="username" id="username" placeholder="请填写孩子身份证号">
		                </div>
		                <div class="input-row">
	                ...
	                <button id="btn1" onclick="document.location.href='../f/register'" class="submit block" data-icon="key">注册</button>
 	              <!--   <input type="button" name="reg" value="注册"  style="width:150px,color:red;" onclick="document.location.href='../f/register'">
